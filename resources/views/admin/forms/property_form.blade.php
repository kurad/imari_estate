<form action="{{ route('properties.store') }}" method="POST" enctype="multipart/form-data"
      ...
      <div>
          ...
          <input type="text" name="title" class="w-full border border-gray-300 rounded-lg p-2"
              placeholder="e.g. 3 Bedroom Apartment in Kigali">
      </div>
      ...
      <div>
          ...
          <input type="text" name="location" class="w-full border border-gray-300 rounded-lg p-2"
      ...
      <div>
          ...
          <input type="number" name="price" class="w-full border border-gray-300 rounded-lg p-2"
      ...
      <div id="bedrooms-field">
          ...
          <input type="number" name="bedrooms" class="w-full border border-gray-300 rounded-lg p-2"
              placeholder="e.g. 3">
      </div>
      ...
      <div id="bathrooms-field">
          ...
          <input type="number" name="bathrooms" class="w-full border border-gray-300 rounded-lg p-2"
              placeholder="e.g. 2">
      </div>
      ...
      <div class="md:col-span-2">
          ...
          <textarea name="description" rows="4" class="w-full border border-gray-300 rounded-lg p-2"
      ...
      <div class="md:col-span-2">
          <label class="block text-sm font-medium text-gray-600 mb-1">Video Link</label>
          <input type="url" name="video_link" class="w-full border border-gray-300 rounded-lg p-2"
      ...
      <div class="md:col-span-2">
          ...
          <input type="text" name="contact" class="w-full border border-gray-300 rounded-lg p-2"
              placeholder="e.g. +250 780 123 456 or email@example.com">
      </div>

      <!-- Submit -->
      <div class="flex justify-end p-4 border-t">
          {{-- <button onclick="closeModal()" class="px-4 py-2 text-gray-600 mr-2 rounded-lg hover:bg-gray-100">Cancel</button> --}}
          <button type="submit" class="px-4 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600">Add
              Property</button>
      </div>
  </form>
  <script>
