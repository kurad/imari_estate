    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center py-4 md:py-6">
            ...
            <div class="hidden md:flex items-center space-x-4">
                <a href="#" class="hover:text-orange-500 transition-colors duration-300">
                    <i class="fab fa-facebook-f text-3xl text-[#1877F3]"></i>
                </a>
                <a href="#" class="hover:text-orange-500 transition-colors duration-300">
                    <i class="fab fa-x-twitter text-3xl text-black"></i>
                </a>
                <a href="#" class="hover:text-orange-500 transition-colors duration-300">
                    <i class="fab fa-linkedin-in text-3xl text-[#0A66C2]"></i>
                </a>
                <a href="https://www.instagram.com/real.estaterwanda/" class="hover:text-orange-500 transition-colors duration-300">
                    <i class="fab fa-instagram text-3xl text-[#E4405F]"></i>
                </a>
                <a href="https://www.youtube.com/@realestaterwanda" class="hover:text-orange-500 transition-colors duration-300">
